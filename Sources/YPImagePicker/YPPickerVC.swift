...
open class YPPickerVC: YPBottomPager, YPBottomPagerDelegate {
    ...
    func setTitleViewWithTitle(aTitle: String) {
        ...
        label.textColor = YPConfig.colors.navTitleColor
        ...
        if YPConfig.library.options != nil {
            ...
            arrow.tintColor = YPConfig.colors.navTitleColor
    ...
    func updateUI() {
        ...
        navigationItem.rightBarButtonItem?.setFont(font: YPConfig.fonts.rightBarButtonFont)
        navigationItem.rightBarButtonItem?.setFont(font: YPConfig.fonts.rightBarButtonFont)
        navigationItem.leftBarButtonItem?.setFont(font: YPConfig.fonts.leftBarButtonFont)
    }
